...
import 'package:event_planning_app/core/geocoding_helper.dart';
...
class UpdateEventScreen extends StatefulWidget {
  ...
  static const String routeName = "UpdateEventScreen";
...
class _UpdateEventScreenState extends State<UpdateEventScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(eventModel==null?
          StringsManager.createEvent.tr():StringsManager.editEvent.tr(),
            style: Theme
                .of(context)
                .textTheme
                .titleMedium
        ...
        body: Consumer<LocationProvider>(builder: (context, provider, child) {
          ...
          return DefaultTabController(
            initialIndex: eventModel != null ? selectedIndexOfCategory() : 0,
            length: 3,
            child: Form(
              key: formKey,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: CustomButton(
                            text: StringsManager.editEvent.tr(),
                            onPressed: () async {
                            await  updateEvent(provider,eventModel!.eventId!);
  ...
  int selectedIndexOfCategory() {
    if (eventModel?.category == bookCategory) {
      return 0;
    } else if (eventModel?.category  ==sportCategory) {
      return  1 ;
    } else {
      return 2;
    }
  ...
  updateEvent(LocationProvider locationProvider,String id) async {
      ...
      if (selectedTime != null && selectedDate != null) {
        if(locationProvider.eventLocation!=null){
          ...
          DialogUtils.showToast(
              StringsManager.editEventSuccessfully.tr(), context);
        }else{
